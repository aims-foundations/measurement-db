- Scope: MedHELM v4.0.0, 13 model runs, 7,761 observations and 597 distinct full-prompt/grading items. Sources and the selected metric are pinned in `metadata.yaml`.
