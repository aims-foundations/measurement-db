- Scope: MedHELM v4.0.0, 13 model runs, 13,000 observations and 1,000 distinct full-prompt/grading items. Sources and the selected metric are pinned in `metadata.yaml`.
