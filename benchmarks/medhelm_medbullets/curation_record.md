- Scope: MedHELM v4.0.0, 13 model runs, 4,004 observations and 298 distinct full-prompt/grading items. Sources and the selected metric are pinned in `metadata.yaml`.
